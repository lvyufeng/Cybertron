...
from cybertron.transformers import is_ms_available
from cybertron.transformers.testing_utils import require_ms, slow
from ..test_modeling_ms_common import floats_tensor, ids_tensor
...
if is_ms_available():
    ...
    from cybertron.transformers.generation import (
...
class GenerationTesterMixin:
    ...
    def _get_input_ids_and_config(self):
        ...
        if "transfoxl" in config.__class__.__name__.lower():
            ...
            attention_mask = ops.ones_like(input_ids)[:max_batch_size, :sequence_length]
    ...
    def test_greedy_generate(self):
        ...
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_greedy.asnumpy().tolist(), output_generate.asnumpy().tolist())
    ...
    def test_greedy_generate_dict_outputs(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.sequences.asnumpy().tolist(), output_greedy.sequences.asnumpy().tolist())
    ...
    def test_beam_search_generate(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.asnumpy().tolist(), output_beam_search.asnumpy().tolist())
    ...
    def test_beam_search_generate_dict_output(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.sequences.asnumpy().tolist(), output_beam_search.sequences.asnumpy().tolist())
            self.assertTrue(
    ...
    def test_beam_search_generate_dict_outputs_use_cache(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.sequences.asnumpy().tolist(), output_beam.sequences.asnumpy().tolist())
    ...
    def test_beam_sample_generate(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.asnumpy().tolist(), output_beam_sample.asnumpy().tolist())
    ...
    def test_beam_sample_generate_dict_output(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.sequences.asnumpy().tolist(), output_beam_sample.sequences.asnumpy().tolist())
            self.assertTrue(
    ...
    def test_group_beam_search_generate(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.asnumpy().tolist(), output_group_beam_search.asnumpy().tolist())
    ...
    def test_group_beam_search_generate_dict_output(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.sequences.asnumpy().tolist(), output_group_beam_search.sequences.asnumpy().tolist())
            self.assertTrue(
                np.allclose(
    ...
    def test_constrained_beam_search_generate(self):
        for model_class in self.all_generative_model_classes:
            ...
            if not input_ids.dtype == mindspore.float32:
                min_id = (ops.amin(input_ids) + 3).asnumpy().item()
                max_id = ops.amax(input_ids).asnumpy().item()
            else:
                # otherwise this throws an error for Speech2TextModel since its inputs are floating points
                min_id = 3
                max_id = 100

            force_tokens = ops.randint(min_id, max_id, (1, 2)).asnumpy().tolist()[0]
            constraints = [
    ...
    def test_contrastive_generate(self):
        ...
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_contrastive.asnumpy().tolist(), output_generate.asnumpy().tolist())
    ...
    def test_contrastive_generate_dict_outputs_use_cache(self):
        for model_class in self.all_generative_model_classes:
            ...
            self.assertListEqual(output_generate.sequences.asnumpy().tolist(), output_contrastive.sequences.asnumpy().tolist())
