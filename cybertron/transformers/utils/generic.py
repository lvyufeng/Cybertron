...
def is_ms_tensor(x):
    ...
    """
    return False if not is_ms_available() else _is_ms(x)
...
def squeeze(array, axis=None):
    ...
    if is_numpy_array(array):
        ...
        return array.squeeze() if axis is None else array.squeeze(axis)
    else:
...
def expand_dims(array, axis):
    ...
    if is_numpy_array(array):
        ...
        return array.expand_dims(axis=axis)
    else:
